export default class Constants {
  ...
  constructor() {
    ...
    this._colorSchemes = [
      ...
      { name: 'colorScheme',  value: 'epilogos-18state-human',   label: 'Epilogos (18-state, human)' },
      { name: 'colorScheme',  value: 'epilogos-25state-human',   label: 'Epilogos (25-state, human)' },
      { name: 'colorScheme',  value: 'epilogos-15state-mouse',   label: 'Epilogos (15-state, mouse)' },
